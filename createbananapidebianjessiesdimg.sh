...
cd /tmp
dd if=/dev/zero bs=1M count=2000 > /tmp/debianbanana20151223.img

losetup -f --show -P /tmp/debianbanana20151223.img
...
qemu-debootstrap --verbose --include=${kernel},locales,flash-kernel,sunxi-tools --arch=armhf jessie /mnt http://ftp.debian.org/debian
